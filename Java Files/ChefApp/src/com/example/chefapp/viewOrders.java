...
//		}
		...
		String[] menuItems = {"Kokanee","Budweiser","Chivas","Ballantines","Pizza","Hamburger","Sandwich","French Fries","Edamame","Salad","Cheese","Special 1","Special 2"};
		...
		for(int j=0; j<numberCustomers; j++)
		{
			...
			for(int i = 0 ; i < Customer[j].length ; i++)
			{	
				//int array1[] = Customer[j];
				if (!Customer[j].equals("0"))
				...
				{	
					...
					b = new TextView(this);
					b.setText(menuItems[i]+": "+ Customer[j]);
					b.setId(i);
					b.setTextSize(20);
		...
		//Kokanee, Budweiser, Chivas, Ballantines, Pizza, Hamburger, Sandwich, French Fries, Edamame, Salad, Cheese, Special 1, Special 2
