...
public class Connection extends Activity {
	...
	/* Send empty message to OrderAppClient to update the Chef Client ID on Orderside*/
	public void sendChefClientID(int orderClientID) {
		ConnectionApplication app = (ConnectionApplication) getApplication();
...
//							});
							...
							sendChefClientID(orderClientID);
						}
					}
				} catch (IOException e) {
					e.printStackTrace();
